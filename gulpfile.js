...
// js file paths
var utilJsPath = 'main/js'; // util.js path - you may need to update this if including the framework as external node module
var componentsJsPath = 'main/js/**/*.js'; // component js files
var scriptsJsPath = 'dist/js'; //folder for final scripts.js/scripts.min.js files

// css file paths
var cssFolder = 'dist/css'; // folder for final style.css/style-custom-prop-fallbac.css files
var scssFilesPath = 'main/css/**/*.scss'; // scss files to watch
